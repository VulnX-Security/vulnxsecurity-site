...
export default function ContactForm({
    ...
    return (
        <section className={`mx-auto max-w-3xl px-4 py-16 ${className}`.trim()}>
            ...
            {status && (
                <div
                    className={`mt-6 rounded border p-4 text-sm ${status.type === "success"
            ...
            <form onSubmit={handleSubmit} noValidate className="mt-8 grid gap-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        name="name"
                        required
                        className={`mt-1 w-full rounded bg-neutral-900 border p-3 ${touched.name && errors.name ? "border-red-700" : "border-neutral-800"
                            }`}
                        value={values.name}
                        onChange={handleChange}
                        onBlur={handleBlur}
                ...
                <div>
                    ...
                    <input
                        ...
                        name="email"
                        required
                        className={`mt-1 w-full rounded bg-neutral-900 border p-3 ${touched.email && errors.email ? "border-red-700" : "border-neutral-800"
                            }`}
                        value={values.email}
                        onChange={handleChange}
                        onBlur={handleBlur}
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={5}
                        required
                        className={`mt-1 w-full rounded bg-neutral-900 border p-3 ${touched.message && errors.message ? "border-red-700" : "border-neutral-800"
                            }`}
